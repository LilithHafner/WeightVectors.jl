...
function pathalogical_compaction_setup()
...
function pathalogical_compaction_update(w)
    w[end] = 2
    w[end] = 1
end
SUITE["pathological compaction"] = @benchmarkable pathalogical_compaction_setup pathalogical_compaction_update

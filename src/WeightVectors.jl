...
function _rand_slow_path(rng::AbstractRNG, m::Memory{UInt64}, i)
    ...
    if m5 < UInt64(1)<<32
        ...
        @inbounds @simd for i in Sys.WORD_SIZE:-1:0 # This loop is backwards so that memory access is forwards. TODO for perf, we can get away with shaving 1 to 10 off of this loop.
